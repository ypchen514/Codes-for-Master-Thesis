...
%     toc
    % Call indice
    St_1 = abs(Sj(1).total_effect);
    St_2 = abs(Sj(2).total_effect);
    St_3 = abs(Sj(3).total_effect);
    St_4 = abs(Sj(4).total_effect);
    S1 = abs(Sj(1).main_effect);
    S2 = abs(Sj(2).main_effect);
    S3 = abs(Sj(3).main_effect);
    S4 = abs(Sj(4).main_effect);
    % Cost function
    s_cost = ((St_3-S3)/S3 + (S1+S4+S2)/S3)/var_g;
