...
I_z = 50.0684*ones(runcycle,1);

% tire
C_alpha = 1516.1*ones(runcycle,1);
C_beta = 55.2672*ones(runcycle,1);
SAP = 0.0209*ones(runcycle,1);
...
%rolling resistance
mu_rolling_1 = 0.0041*ones(runcycle,1);
mu_rolling_2 = 0.000505*ones(runcycle,1);
