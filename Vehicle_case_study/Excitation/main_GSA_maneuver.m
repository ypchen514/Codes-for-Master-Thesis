...
N = 1e4; % GSA monte carlo sampling numbers
...
S_data(i).GSA_num = N;
S_data(i).out_x = S_x_out;
S_data(i).out_y = S_y_out;
S_data(i).out_yaw = S_yaw_out;
S_data(i).index_x = S_index_x;
S_data(i).index_y = S_index_y;
S_data(i).index_yaw = S_index_yaw;
S_data(i).lambda_x = lambda_x;
S_data(i).lambda_y = lambda_y;
S_data(i).lambda_yaw = lambda_yaw;
